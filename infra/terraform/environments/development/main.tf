# Ambiente de workload Development (ver ADR-0011).
# Auto-deploy apos publicacao real no ECR (nunca requer aprovacao humana),
# capacidade reduzida, sem paridade completa com Production.
...
# --- IAM/OIDC: role de deploy assumida pelo workflow de deploy a Development (ver ADR-0014) ---
