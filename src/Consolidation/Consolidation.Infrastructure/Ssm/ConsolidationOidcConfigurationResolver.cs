...
namespace BancoCarrefour.Consolidation.Infrastructure.Ssm;

public sealed record OidcConfiguration(string Authority, string Audience);

/// <summary>
/// Resolve issuer/audience OIDC do Consolidation.Api a partir do SSM
/// Parameter Store — fonte autoritativa em runtime oficial (ADR-0009). Lido
/// uma única vez no startup (nunca por request, nunca por polling): depois
/// de resolvido, o valor permanece em memória durante toda a vida da
...
/// </summary>
public static class ConsolidationOidcConfigurationResolver
{
