...
Esta pasta contém o registro de decisões arquiteturais da solução.

Documentos:

- `registro-de-decisoes.md` — visão consolidada das decisões.
- `ADR-0000-semantica-do-consolidado-diario.md` — Semântica do consolidado diário.
- `ADR-0001-fronteiras-entre-lancamentos-e-consolidado.md` — Fronteiras entre Lançamentos e Consolidado.
- `ADR-0002-outbox-e-publicacao-confiavel.md` — Outbox e publicação confiável.
- `ADR-0003-consumo-at-least-once-e-idempotente.md` — Consumo at-least-once e idempotente.
- `ADR-0004-projecao-materializada-do-consolidado.md` — Projeção materializada do Consolidado.
- `ADR-0005-persistencias-independentes-por-fronteira.md` — Persistências independentes por fronteira.
- `ADR-0006-persistencia-relacional-e-postgresql.md` — Persistência relacional e PostgreSQL.
