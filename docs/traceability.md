...
| 50 RPS do Consolidado | Validado localmente/container-first | Execução local usa JWT com issuer/audience e atingiu 50.02 req/s sustentado, 0% falhas, p95 6.49 ms e p99 8.68 ms, validando throughput mínimo observado de 50 RPS. Validação produtiva permanece pendente. |
